...
public class CustomImageClassifier {
  ...
  private static final String LOCAL_MODEL_NAME = "hotdog";

  /** Path of the model file stored in Assets. */
  private static final String LOCAL_MODEL_PATH = "hotdog.tflite";

  /** Name of the model uploaded to the Firebase console. */
  private static final String HOSTED_MODEL_NAME = "hotdog";
